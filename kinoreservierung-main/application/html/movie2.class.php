...
$num = 1;
while($num < 101){
    $sql = "INSERT INTO cinemaroomtwo (movieid, usersid, seatid, blocked) VALUES ('2', NULL, '$num', '0')";
            ...
            if($num > 0){
                ...
                foreach ($usrsFromDatabase as $usrs) {
                    ...
                    if($username == $usrname && $email == $mail){
                        $block = "SELECT blocked, seatid FROM cinemaroomtwo WHERE movieid = '1'";
                        ...
                        foreach ($seatsFromDatabase as $seats) {
                            ...
                            if($seat == $seatsid){
                                if($blocked == 0){
                                    echo "i still work";
                                    $query = "UPDATE cinemaroomtwo SET usersid = '$users', blocked = '1' WHERE seatid = '$seat'";
